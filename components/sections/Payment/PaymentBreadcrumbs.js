...
export default function PaymentBreadcrumbs() {
  ...
  return (
    <div className={
      stepNumber === 1 ? "payment-breadcrumbs payment-breadcrumbs_first-step" :
        stepNumber === 2 ? "payment-breadcrumbs payment-breadcrumbs_second-step" :
          "payment-breadcrumbs payment-breadcrumbs_third-step"
    }>
