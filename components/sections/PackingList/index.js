...
export default function PackingList() {
  ...
  const YoutubeIframe = () => {
    return (
      <iframe
        className="packing-list__video-iframe"
        width="560"
        height="315"
      ...
      <div className="container packing-list__container">
        ...
        <div className="packing-list__media">
          ...
          <div
            ...
            className="packing-list__video-wrapper"
          >
            <img
              className={
                overlay
                  ? "packing-list__video-poster"
                  : "packing-list__video-poster disabled"
              }
              alt="YouTube video player"
              src="https://i.ytimg.com/vi/Vq0JCR6_YpA/hqdefault.jpg"
            />
            <div
              className={
                overlay
                  ? "packing-list__video-button"
                  : "packing-list__video-button disabled"
              }
            >
              <svg
                className="packing-list__video-icon"
                height="100%"
                version="1.1"
                viewBox="0 0 68 48"
                width="100%"
              >
                ...
                ></path>
                <path
                  className="packing-list__video-icon-shape"
