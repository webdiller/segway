...
export default function DidntFindModal({ isWhiteMode = true }) {
  ...
  return (
    <div
      className={
        activeModal && !whiteModeState
          ? "didnt-find-modal active"
          : activeModal && whiteModeState
          ? "didnt-find-modal didnt-find-modal_white-mode active"
          : !activeModal && whiteModeState
          ? "didnt-find-modal didnt-find-modal_white-mode"
          : "didnt-find-modal"
      }
    >
      <div className="didnt-find-modal__wrapper">
        <button
          ...
          className="didnt-find-modal__close-btn"
        >
          <img
            className="didnt-find-modal__close-btn-icon didnt-find-modal__close-btn-icon_desktop"
        ...
        <div className="didnt-find-modal__bg-wrapper">
          ...
          <Image
            src={whiteModeState ? bgImageDark : bgImageDark}
            alt="Didn’t find a model?"
          />
        </div>
        <img
          className="didnt-find-modal__question-icon"
        ...
        <div className="didnt-find-modal__content">
          ...
          <p className="text didnt-find-modal__description">
