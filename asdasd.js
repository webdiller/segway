...
9.3 mph (15 km/h), and 12.4 mph (20 km/h) respectively. <br/>
...
Pedestrian Mode, Energy-saving Mode, Standard <br/>
Mode and Sport Mode with a preset speed limit of <br/>
3.7 mph (6 km/h), 6.2 mph (10 km/h), 9.3 mph (15 km/h), <br/>
and 12.4 mph (20 km/h) respectively.
...
steering to ensure a safe ride. In addition, the 140 mm <br/>
disc brakes increase reaction time by up to 27% <br/>
...
With the powerful brushless direct current motor, <br/> the Ninebot KickScooter F Series delivers a fast <br/> and sturdy riding experience. The use of a high <br/> power heat dissipation force increases the service <br/> life of the motor, and the low heat prevents the <br/> motor from burning out.
...
Simultaneous mechanical front drum brake <br/>
and regenerative electric back brake provide <br/>
both stability and steerability. <br/> <br/>
...
stability and steerability. <br/> <br/>
...
# 5
Regenerative Brake for <br/> 
Power Recycle

The innovative regenerative brake system turns Ninebot KickScooter MAX <br/> 
into an electric vehicle powered by electricity and recycled energy from <br/> 
riding. Energy will be collected from regenerative braking <br/> 
and distributed when you need a boost.
# 5
Regenerative Brake <br/> 
for Power Recycle

The innovative regenerative brake system turns <br/> 
Ninebot KickScooter MAX into an electric vehicle <br/> 
powered by electricity and recycled energy from <br/> 
riding. Energy will be collected from regenerative <br/> 
...
The KickScooter MAX G30LE can climb slopes up <br/>
to 20 % thanks to its powerful motor, allowing it to <br/>
go uphill easily. In addition, the rear-wheel drive <br/>
offers better acceleration stability and power <br/>
efficiency.
# 6
Rear-wheel drive for the best <br/>
driving experience

The KickScooter MAX G30LE can climb slopes up <br/>
to 20 % thanks to its powerful motor, allowing it to 
go uphill easily. In addition, the rear-wheel drive <br/>
offers better acceleration stability and power <br/>
efficiency.
# 7
Choose your Riding <br/>
mode on the LED <br/>
Digital Dashboard

The LED digital dashboard can not only show you <br/>
the battery level, speed information, Bluetooth <br/>
connectivity at a glance, but can also allow you <br/>
to easily choose one of the 3 riding modes. <br/>
By clicking twice on the intuitive LED dashboard, you <br/>
can directly switch between Eco, Standard, and <br/>
Sports modes, depending on your envy and your <br/>
riding style.
# 7
...
The LED digital dashboard can not only show you <br/>
the battery level, speed information, Bluetooth <br/>
connectivity at a glance, but can also allow you to <br/>
easily choose one of the 3 riding modes. <br/>
By clicking twice on the intuitive LED dashboard, <br/>
you can directly switch between Eco, Standard, <br/>
and Sports modes, depending on your envy and <br/>
your riding style.
...
Our Smart Battery Management System (Smart-<br/>
...
Front-facing lights are designed with 1.5w high- <br/>
brightness LED light to illuminate the path <br/>
ahead of you and increase your visibility to <br/>
others around you.
...
slim body, vibrant colors (blue & pink). <br/> <br/>
