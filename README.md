...
## Остановился:
- Добавление активного класса для top swiper
- Добавление бесплатной гарантии
- Добавление фикс. категорий


Stripe:
- Сколько по времени исходя функционала сайта?
- Какие шаги?


СЕО оптимизацию можно месяцами делать, смотреть на поведение пользователей и исходя из этого делать улучшения. Смотреть на то как реагируют роботы. ПОднимать
...
export const data = {
  ...
  segways: {
    ...
    kidsSegways: [
      {
        excludeForMap: true,
        id: "id=011&warranty=null&color=0",
        type: "kidsScooter",
        brandName: "Ninebot",
      ...
      {
        id: "id=012&warranty=null&color=1",
        type: "kidsScooter",
        brandName: "Ninebot",
        name: "Ninebot Kickscooter Zing e8",
        nameWithoutBrand: "Kickscooter\nE8",
