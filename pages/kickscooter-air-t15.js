  ...
  return (
    <>
      ...
      <Welcome
        ...
        currentSegway={allData.segways.adultSegways[2]}
      />
      <Tabs />
      ...
      <KickScooterOverviewDinamic title="KickScooter overview" subtitle="SEGWAY Ninebot Kickscooter AIR T15" desktopImage={OverviewImgDesktop} mobileImage={OverviewImgMobile} />
      ...
      <CompareSpecificationsDinamic items={allData.segways} mainSegway={allData.segways.adultSegways[2]} />
      ...
      <WarrancyPaymentImageDinamic
        ...
        heightMobile={354}
        customClass="ks-e-45"
        item={allData.segways.adultSegways[2]}
      />
