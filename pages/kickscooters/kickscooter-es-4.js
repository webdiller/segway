...
export default function ModelPage({allData}) {
  ...
  useEffect(() => {
    dispatch(setSegway(allData.segways.adultSegways[9]));
    dispatch(setPrice(allData.segways.adultSegways[9].price));
  }, []);
  ...
  return (
    <>
      ...
      <Welcome
        ...
        currentSegway={allData.segways.adultSegways[9]}
      />
      <Tabs />
      ...
      <KickScooterOverviewDinamic title="KickScooter overview" subtitle="SEGWAY Ninebot Kickscooter ES4" desktopImage={OverviewImgDesktop} mobileImage={OverviewImgMobile} />
      ...
      <CompareSpecificationsDinamic items={allData.segways} mainSegway={allData.segways.adultSegways[9]} />
      ...
      <WarrancyPaymentImageDinamic
        ...
        heightMobile={354}
        customClass="ks-e-45"
        item={allData.segways.adultSegways[9]}
      />
      <OtherModelsDinamic items={[...allData.segways.adultSegways, ...allData.segways.kidsSegways]} />
      <FixedModalDinamic segwayItem={allData.segways.adultSegways[9]} />
