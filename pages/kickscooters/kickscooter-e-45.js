...
export default function ModelPage({ allData }) {
  ...
  return (
    <>
      ...
      />
      <PackingListDinamic packingListYoutubeEmbedId={allData.segways[4].packingListYoutubeEmbedId} packingListImg={allData.segways[4].packingListImg} />
      ...
      <DownloadManualDinamic manualImgPath={allData.segways[4].manualImgPath} downloadManualHref={allData.segways[4].downloadManual} />
