...
export default function ModelPage({ allData }) {
  ...
  return (
    <>
      ...
      />
      <PackingListDinamic packingListImg={allData.segways[12].packingListImg} />
      ...
      <FeatureSimpleDinamic
        ...
        textDesktop={
          <>
            ...
            Ninebot KickScooter by Segway zing E8 allows you to travel farther <br />
        ...
        textMobile={
          <>
            ...
            batteries, the Ninebot KickScooter by Segway zing E8 <br />
      ...
      <DownloadManualDinamic downloadManualHref={allData.segways[12].downloadManual} />
