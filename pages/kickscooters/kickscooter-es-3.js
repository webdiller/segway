  ...
  return (
    <>
      ...
      <Welcome
        ...
        currentSegway={allData.segways[9]}
      />
      <Tabs
        showApp
      ...
      />
      <PackingListDinamic packingListYoutubeEmbedId={allData.segways[9].packingListYoutubeEmbedId} packingListImg={allData.segways[9].packingListImg} />
      ...
      <DownloadManualDinamic manualImgPath={allData.segways[9].manualImgPath} downloadManualHref={allData.segways[9].downloadManual} />
      <CompareSpecificationsDinamic items={allData.segways} mainSegway={allData.segways[9]} />
      ...
      <WarrancyPaymentImageDinamic
        ...
        heightMobile={354}
        customClass="ks-e-45"
        item={allData.segways[9]}
      />
      <OtherModelsDinamic items={allData.segways} />
      <DiscountModalDinamic />
      <ProductModalDinamic accessoeries={allData.accessoeries} />
      <FancyModal images={allData.segways[9].galleryImages} />
    </>
  );
}
