...
export default function ModelPage({allData}) {
  ...
  useEffect(() => {
    dispatch(setSegway(allData.segways.adultSegways[8]));
    dispatch(setPrice(allData.segways.adultSegways[8].price));
  }, []);
  ...
  return (
    <>
      ...
      <Welcome
        ...
        currentSegway={allData.segways.adultSegways[8]}
      />
      <Tabs />
      ...
      <KickScooterOverviewDinamic title="KickScooter overview" subtitle="SEGWAY Ninebot Kickscooter ES3" desktopImage={OverviewImgDesktop} mobileImage={OverviewImgMobile} />
      ...
      <CompareSpecificationsDinamic items={allData.segways} mainSegway={allData.segways.adultSegways[8]} />
      ...
      <WarrancyPaymentImageDinamic
        ...
        heightMobile={354}
        customClass="ks-e-45"
        item={allData.segways.adultSegways[8]}
      />
      <OtherModelsDinamic items={[...allData.segways.adultSegways, ...allData.segways.kidsSegways]} />
      <FixedModalDinamic segwayItem={allData.segways.adultSegways[8]} />
