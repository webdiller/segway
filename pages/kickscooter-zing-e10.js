...
export default function Home({allData}) {
  ...
  useEffect(() => {
    dispatch(setSegway(allData.segways.kidsSegways[1]));
    dispatch(setPrice(allData.segways.kidsSegways[1].price));
  }, []);
  ...
  return (
    <>
      ...
      <KickScooterOverviewDinamic title="KickScooter overview" subtitle="SEGWAY Ninebot Kickscooter ZING e10" desktopImage={OverviewImgDesktop} mobileImage={OverviewImgMobile} />
