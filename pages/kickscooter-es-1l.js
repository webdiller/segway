...
export default function Home({allData}) {
  ...
  useEffect(() => {
    dispatch(setSegway(allData.segways.adultSegways[1]));
    dispatch(setPrice(allData.segways.adultSegways[1].price));
  }, []);
  ...
  return (
    <>
      ...
      <Welcome
        ...
        currentSegway={allData.segways.adultSegways[1]}
      />
      <Tabs />
      ...
      <KickScooterOverviewDinamic title="KickScooter overview" subtitle="SEGWAY Ninebot Kickscooter ES1L" desktopImage={OverviewImgDesktop} mobileImage={OverviewImgMobile} />
      ...
      <CompareSpecificationsDinamic items={allData.segways} mainSegway={allData.segways.adultSegways[1]} />
      ...
      <WarrancyPaymentImageDinamic
        ...
        heightMobile={368}
        customClass="ks-e-45"
        item={allData.segways.adultSegways[1]}
      />

      <OtherModelsDinamic items={[...allData.segways.adultSegways, ...allData.segways.kidsSegways]} />
      <FixedModalDinamic segwayItem={allData.segways.adultSegways[1]} />
